...
public class TrabalhadorPeca extends Trabalhador {
    ...
    public String toString() {
        return String.format("Trabalhador à Peça: %s %nNº de Peças do Tipo 1: " + "%d %nNº de Peças do Tipo 2: %d",
    ...
    public float calcularVencimento() {
        return numeroPecasTipo1 * pagamentoPecaTipo1 + numeroPecasTipo2 * pagamentoPecaTipo2;
    }
